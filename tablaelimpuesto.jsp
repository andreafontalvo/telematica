			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<section class="box special features">
							...
							<h4 align="justify">Los puestos de votación registrados en el sistema son los mostrados en la siguiente tabla; si se desea modificar o eliminar algun puesto de votación, puede llevar a cabo el proceso en los botones contiguos a los respectivos puestos</h4><br>
							<table>
								<tr>
