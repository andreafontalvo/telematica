				...
				<section id="main" class="container">
					...
					<section class="box special features">
						<div class="features-row">
							<section>						
								<h3>Registre un puesto de votación</h3>
 							<form action="registropuesto.jsp" method="post">
							     <p align="right">Ingrese nombre del puesto de votación
							     <input type="text" id="name" name="nombrepuesto" placeholder="Nombre del puesto" required="" /><br>
							     Ingrese dirección del puesto de votación
							     <input type="text" id="dirpuesto" name="dirpuesto" placeholder="Dirección" required="" /><br>
							     Ingrese ciudad del puesto de votación
							     <input type="text" id="ciudadpuesto" name="ciudadpuesto" placeholder="Ciudad" required="" /><br>
							<input type="submit" name="Enviar" value="Registrar Puesto" class="button special fit"/></p>
							</form>
							</section>

							<section>
							<h3 align="right"> Puestos de Votación</h3>
							...
							<form action="eliminarfila.jsp" method="post">	
								<div class="row uniform 50%">
									<div class="6u 12u(mobilep)">
							       		 <input type="number" name="eliminar" placeholder=" #Puesto" class="button alt fit small" required="" />
							        </div>				
